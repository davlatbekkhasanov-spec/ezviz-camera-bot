...
import { wantsPersonHistory } from "./person-search.mjs";
...
export function needsLiveCamera(text) {
  if (wantsPersonHistory(text)) return false;
  const t = norm(text);
  return (
...
export { wantsPersonHistory, wantsHistoryPhoto, parsePersonName } from "./person-search.mjs";
