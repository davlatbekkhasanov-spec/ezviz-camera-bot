...
function systemPrompt({ isMasterUser, mode = "default" }) {
  ...
  return (
    ...
    `- MUHIM: Kadr vaqt tamg'asini (masalan 06-18-2026) hech qachon «odam ko'rindi» deb aytma.\n` +
    `- Jurnal bo'sh yoki odam topilmasa — «jurnalda yo'q» deb to'g'ri ayt, taxmin qilma.\n` +
    `- Odamni kadrga qarab tanima — faqat Face ID, yuz tanish yoki usta aytgan yozuvlar.\n` +
    (mode === "person_check"
